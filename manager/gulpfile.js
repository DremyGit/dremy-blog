...
gulp.task('start:client', ['start:server', 'styles', 'jades'], function () {
...
gulp.task('client:build', ['html', 'jades', 'styles'], function () {
...
gulp.task('html', function () {
  return gulp.src([yeoman.app + '/views/**/*.html', '.tmp/views/**/*.html'])
